              ...
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Our multilingual AI will interview helpers via video calls, 
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-slate-600">
                    Discover verified maids, cooks, nannies & more in your area 
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <div className="space-y-4 text-left max-w-2xl mx-auto">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <span className="font-semibold">Phase 2 - Q1 2024:</span> AI Interview Agent for helper interviews
                </div>
              </div>
              <div className="flex items-center">
